...
convert abs_tsne.png -pointsize 50 -gravity NorthWest -annotate +0+0 "D" abs_tsne.png
convert abs_gradients.png -pointsize 50 -gravity NorthWest -annotate +0+0 "E" abs_gradients.png
...
#Add labels
convert overlap1.png -pointsize 50 -gravity NorthWest -annotate +0+0 "F" overlap1.png
convert overlap2.png -pointsize 50 -gravity NorthWest -annotate +0+0 "G" overlap2.png
convert overlap_tsne.png -pointsize 50 -gravity NorthWest -annotate +0+0 "H" overlap_tsne.png
convert overlap_gradients.png -pointsize 50 -gravity NorthWest -annotate +0+0 "I" overlap_gradients.png
