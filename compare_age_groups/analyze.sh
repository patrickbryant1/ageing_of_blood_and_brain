...
./vis_selected_markers.py --gene_annotations $ANNO --joined_betas $BETAS --sample_sheet $SAMPLES --agelabel $AL --overlapping_probes ../results/overlapping_probes_df.csv --overlapping_genes ../results/total_gene_df.csv --outdir $OUTDIR
